...
public class DiscoveryItemController {
    ...
    private AeronetDataLoadingController loadingController;

    public DiscoveryItemController() {
        try {
            loadingController = new AeronetDataLoadingController(Utils.NO_BASE_NAME);
    ...
    public HashMap<Utils.CalculatedDiscoveryItemType,DiscoveryItem> calculateAverage(@RequestParam(value="site") String site,
        ...
        ArrayList<DiscoveryItem> selectedItems = loadingController.getDiscoveryItems(site, start, end);
